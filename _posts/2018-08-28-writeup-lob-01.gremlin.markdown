...
modify_date: 2024-04-23 00:00:00 +0900
article_header:
  type: cover
  image:
...
argv[1]의 값을 buffer배열로 복사할때 복사되는 크기가 정해져있지 않아 **BoF(Buffer OverFlow) 취약점이 존재**한다.
{:.error}
...
<img src="http://eliez3r.synology.me/assets/img/writeup/lob/01.gremlin/01.png" width="400px">{:.rounded.shadow}
...
<img src="http://eliez3r.synology.me/assets/img/writeup/lob/01.gremlin/02.png" width="400px">{:.rounded.shadow}
...
<img src="http://eliez3r.synology.me/assets/img/writeup/lob/01.gremlin/03.png" width="500px">{:.rounded.shadow}
...
<img src="http://eliez3r.synology.me/assets/img/writeup/lob/01.gremlin/04.png" width="400px">{:.rounded.shadow}
...
<img src="http://eliez3r.synology.me/assets/img/writeup/lob/01.gremlin/05.png" width="800px">{:.rounded.shadow}
...
<img src="http://eliez3r.synology.me/assets/img/writeup/lob/01.gremlin/06.png" width="700px">{:.rounded.shadow}

<img src="http://eliez3r.synology.me/assets/img/writeup/lob/01.gremlin/07.png" width="400px">{:.rounded.shadow}

예상한대로 ebp가 "BBBB"로 채워졌으며, EIP가 "CCCC"로 채워졌음을 확인 할 수 있다.

<br>

<img src="http://eliez3r.synology.me/assets/img/writeup/lob/01.gremlin/08.png" width="500px">{:.rounded.shadow}
...
<img src="http://eliez3r.synology.me/assets/img/writeup/lob/01.gremlin/09.png" width="500px">{:.rounded.shadow}
...
<img src="http://eliez3r.synology.me/assets/img/writeup/lob/01.gremlin/10.png" width="800px">{:.rounded.shadow}
