...
<img src="/assets/img/writeup/webkr/Level 05/image-20180729140333626.png" width="400px">
...
<img src="/assets/img/writeup/webkr/Level 05/image-20180729140610737.png" width="300px">

로그인 창이 뜨길래 'test' 값을 둘다 넣어 login해보았다.

<img src="/assets/img/writeup/webkr/Level 05/image-20180729140712120.png" width="200px">

admin으로 로그인해야 되는 것 같다. 그래서 admin으로 로그인 해봤다.

<img src="/assets/img/writeup/webkr/Level 05/image-20180729140804866.png" width="200px">
...
<img src="/assets/img/writeup/webkr/Level 05/image-20180729141259268.png" width="400px">

'혹시나' 가 '역시나'로 바뀌는 순간이였다. 😏

login.php는 우리가 접속했던 페이지이고, join.php 파일을 열어보았다.

<img src="/assets/img/writeup/webkr/Level 05/image-20180729141531176.png" width="500px">
...
<img src="/assets/img/writeup/webkr/Level 05/image-20180729142057566.png" width="400px">

<img src="/assets/img/writeup/webkr/Level 05/image-20180729142130490.png" width="200px">

회원가입할 수 있는 폼 페이지가 불러졌다. 이제 	admin으로 계정을 만들려고 했다.

<img src="/assets/img/writeup/webkr/Level 05/image-20180729142228262.png" width="200px">
...
<img src="/assets/img/writeup/webkr/Level 05/image-20180729142415762.png" width="100px">
...
<img src="/assets/img/writeup/webkr/Level 05/image-20180729142557323.png" width="400px">
