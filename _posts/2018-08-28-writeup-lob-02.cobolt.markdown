---
layout: post
title:  "Level02. cobolt"
subtitle:   "[LOB] Level02. cobolt"
categories: writeup
tags: lob cobolt level02
...
<img src="/assets/img/writeup/lob/02.cobolt/image-20180827223605161.png" width="500px">
...
<img src="/assets/img/writeup/lob/02.cobolt/image-20180827225219317.png" width="700px">

buffer 배열에는 "A", SFP에는 "B", RET에는 "C", 그 뒤로는 "NOP"를 50바이트 그위로 쉘이 들어갈 공간 24바이트에 "S"를 넣었다. 이점을 잘 생각하고 core dump를 보자.



<img src="/assets/img/writeup/lob/02.cobolt/image-20180827225429938.png" width="700px">
...
<img src="/assets/img/writeup/lob/02.cobolt/image-20180827225615182.png" width="700px">
...
<img src="/assets/img/writeup/lob/02.cobolt/image-20180827225742065.png" width="700px">
...
<img src="/assets/img/writeup/lob/02.cobolt/image-20180827230447465.png" width="700px">
...
<img src="/assets/img/writeup/lob/02.cobolt/image-20180827230946829.png" width="700px">
...
<img src="/assets/img/writeup/lob/02.cobolt/image-20180827231211347.png" width="700px">
...
<img src="/assets/img/writeup/lob/02.cobolt/image-20180827231441368.png" width="700px">
...
<img src="/assets/img/writeup/lob/02.cobolt/image-20180827231752514.png" width="500px">

EUNICE 환경 변수의 주소는 0xbffffc21 이다. (쉽죠잉?😁)

이제 이 주소를 RET에 넣으면 끄읏..👌

<img src="/assets/img/writeup/lob/02.cobolt/image-20180827231937161.png" width="600px">
