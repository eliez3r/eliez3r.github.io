...
<img src="/assets/img/writeup/webkr/Level 07/image-20180729233649699.png" width="150px">

<img src="/assets/img/writeup/webkr/Level 07/image-20180729233740588.png" width="400px">
...
<img src="/assets/img/writeup/webkr/Level 07/image-20180729234506533.png" width="500px">
...
<img src="/assets/img/writeup/webkr/Level 07/image-20180729235548415.png" width="300px">



서로 다른 레코드가 담긴 테이블이 2개가 있다. 이때 Union을 이용하면, 한번의 쿼리로 다른 테이블의 값을 추출할 수 있다.

<img src="/assets/img/writeup/webkr/Level 07/image-20180729235818938.png" width="300px">
...
<img src="/assets/img/writeup/webkr/Level 07/image-20180730000349195.png" width="400px">

test3의 테이블에서 where절을 이용하여 'guest'를 추출하고 있다.

역시 Union과 select를 이용하면 어떻게 되는지 살펴보자.

<img src="/assets/img/writeup/webkr/Level 07/image-20180730000514308.png" width="500px">

select 'admin' 을 붙였더니 'admin'도 출력되었다.



<img src="/assets/img/writeup/webkr/Level 07/image-20180730000934101.png" width="400px">
...
<img src="/assets/img/writeup/webkr/Level 07/image-20180730001138181.png" width="500px">
...
![image-20180730002537484](/assets/img/writeup/webkr/Level 07/image-20180730002537484.png)
