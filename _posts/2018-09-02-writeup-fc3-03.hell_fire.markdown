...
subtitle:   "[FC3]dark-eyes → hell_fire"
categories: writeup
tags: fc3 hell_fire level3

---

# dark-eyes → hell_fire

## keyword : another fake_ebp or got overwriting
...
<img src="/assets/img/writeup/fc3/3.hell_fire/image-20180809135427000.png" width="500px">
...
<img src="/assets/img/writeup/fc3/3.hell_fire/image-20180809140252702.png" width="500px">



<img src="/assets/img/writeup/fc3/3.hell_fire/image-20180809140344649.png" width="500px">
...
<img src="/assets/img/writeup/fc3/3.hell_fire/image-20180809143651092.png" width="500px">

fgets함수 실행 부분이다. 빨간 네모 부분이 stdin의 주소이다.

<img src="/assets/img/writeup/fc3/3.hell_fire/image-20180809143945605.png" width="700px">
...
<img src="/assets/img/writeup/fc3/3.hell_fire/image-20180809144700946.png" width="600px">
...
<img src="/assets/img/writeup/fc3/3.hell_fire/image-20180809150011412.png" width="400px">

main함수의 SFP와 start함수의 SFP의 거리는 96Byte이다.

<img src="/assets/img/writeup/fc3/3.hell_fire/image-20180809151811142.png" width="600px">

위와 같은 형태로 페이로드를 작성하면 된다.

최종적으로 살펴보면 다음과 같다.

![image-20180809152851986](/assets/img/writeup/fc3/3.hell_fire/image-20180809152851986.png)
...
- leave-ret Gadget : 0x8048369
  - <img src="/assets/img/writeup/fc3/3.hell_fire/image-20180809153237628.png" width="500px">
- mprotect : 0x714670
  - <img src="/assets/img/writeup/fc3/3.hell_fire/image-20180809153345938.png" width="500px">
